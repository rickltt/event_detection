from utils import ED_Dataset, collate_fn, DataProcessor, find_triggers, calc_metric
import torch
from model import Bert, BertCrf
import numpy as np
import random
import argparse
import os
...
def train(args, model, train_dataset, dev_dataset):
    ...
    logger.info("  Datset = %s", len(args.dataset.upper()))
